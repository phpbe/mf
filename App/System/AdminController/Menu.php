...
class Menu extends \Be\System\AdminController
{
    ...
    public function menusSave()
    {
        ...
        Response::success('保存菜单成功！', adminUrl('System', 'System', 'menus', ['groupId' => $groupId]));
    }
    ...
    public function menuGroupEditSave()
    {
        ...
        if ($tupleMenuGroup->id > 0) {
            Response::error('已存在(' . $className . ')类名！', 0, adminUrl('System', 'System', 'menuGroupEdit', ['id'=>$id]));
        }
        ...
        if ($tupleMenuGroup->save()) {
            ...
            Response::success($id == 0 ? '添加菜单组成功！' : '修改菜单组成功！', adminUrl('System', 'System', 'menuGroups'));
        } else {
            Response::error($tupleMenuGroup->getError(), 1, adminUrl('System', 'System', 'menuGroupEdit', ['id'=>$id]));
        }
    }
    ...
    public function menuGroupDelete()
    {
        ...
        Response::redirect(adminUrl('System', 'System', 'menuGroups'));
