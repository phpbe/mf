...
class FileImpl implements Driver
{
    ...
    {
        $hash = sha1($key);
        $path = Be::getRuntime()->getCachePath() . '/System/Cache/' .  substr($hash, 0, 2) . '/' . substr($hash, 2, 2) . '/' . $hash . '.php';
    ...
    {
        $hash = sha1($key);
        $dir = Be::getRuntime()->getCachePath() . '/System/Cache/' .  substr($hash, 0, 2) . '/' . substr($hash, 2, 2);
    ...
    {
        $path = Be::getRuntime()->getCachePath() . '/System/Cache';
