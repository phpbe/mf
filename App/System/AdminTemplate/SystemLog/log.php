...
if (strlen(serialize($log)) < 100 * 1024) {
    ?>
    <link rel="stylesheet" href="<?php echo adminUrl(); ?>/app/Systme/AdminTemplate/google-code-prettify/prettify.css" type="text/css"/>
    <script type="text/javascript" language="javascript" src="<?php echo adminUrl(); ?>/app/Systme/AdminTemplate/google-code-prettify/prettify.js"></script>
