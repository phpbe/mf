...
class Watermark
{
     ...
     *     ui="return ['form-item' => ['v-show' => 'formData.enable']];")
     */
    public $type = 'text';
     ...
     *     ui = "return ['form-item' => ['v-show' => 'formData.enable && formData.type == \'image\'']];",
     *     maxWidth = "256",
     *     maxHeight = "256",
     * )
     */
     ...
     *     ui = "return ['form-item' => ['v-show' => 'formData.enable && formData.type == \'text\'']];")
     */
    public $text = 'BE';
     ...
     * @BeConfigItem("文印文字大小",
     *     driver = "FormItemInputNumberInt",
     *     ui = "return ['form-item' => ['v-show' => 'formData.enable && formData.type == \'text\''], 'input-number' => [':min' => 1]];")
     */
    public $textSize = 20;
