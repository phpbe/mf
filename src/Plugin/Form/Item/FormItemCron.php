...
class FormItemCron extends FormItem
{
    ...
    public function getHtml()
    {
        ...
        $html .= ' 的 <el-select v-model="formItems.' . $this->name . '.month" @change="formItemCron_pickerChange(\'' . $this->name . '\')" multiple collapse-tags style="width:130px;">';
        ...
        $html .= ' 的 <el-select v-model="formItems.' . $this->name . '.day" @change="formItemCron_pickerChange(\'' . $this->name . '\')" multiple collapse-tags style="width:130px;">';
        ...
        $html .= ' 的 <el-select v-model="formItems.' . $this->name . '.week" @change="formItemCron_pickerChange(\'' . $this->name . '\')" multiple collapse-tags style="width:130px;">';
        $html .= '<el-option label="每天" value="*"></el-option>';
