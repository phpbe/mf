...
class Menu extends \Be\System\Menu
{
  public function __construct()
  {
    ...
    $this->addMenu('Fba', '0', 'el-icon-fa fa-rocket','Fba', '', '');
    $this->addMenu('Fba.Fba','Fba','el-icon-fa fa-user','FBA', '', '');
    $this->addMenu('Fba.Fba.index', 'Fba.Fba', 'el-icon-fa fa-users', '接口测试', beUrl('Fba.Fba.index'), '');
  }
}
